...
public class ByteBuffer {
    private readonly ByteBufferAllocator _buffer;
    ...
    private readonly float[] floathelper = { 0.0f };
    private readonly int[] inthelper = { 0 };
    private readonly double[] doublehelper = { 0.0 };
    private readonly ulong[] ulonghelper = { 0UL };
    ...
    public float GetFloat(int index) {
        var i = (int)ReadLittleEndian(index, sizeof(float));
        inthelper[0] = i;
    ...
    public double GetDouble(int index) {
        var i = ReadLittleEndian(index, sizeof(double));
