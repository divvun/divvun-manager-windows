...
>, IEquatable<TransactionState> {
    ...
    public static implicit operator TransactionState(VerificationError _) {
        return new TransactionState(_);
    }
    ...
    public class InProgress {
        ...
        public InProgress IntoComplete() {
            State = new TransactionProcessState.CompleteState();
            return this;
        }
        ...
        >, IEquatable<TransactionProcessState> {
            ...
            public DownloadState? AsDownloadState => IsT0 ? AsT0 : null;
            public InstallState? AsInstallState => IsT1 ? AsT1 : null;
