...
namespace Divvun.Installer.OneClick.Models
{
    ...
    >, IEquatable<TransactionState>
    {
        ...
        public class InProgress
        {
            ...
            {
                protected TransactionProcessState(OneOf<StartState, DownloadState, InstallState, FinalizingState, CompleteState> input) : base(input)
                {
                }
                ...
                public static implicit operator TransactionProcessState(StartState _) => new TransactionProcessState(_);
                ...
                public static implicit operator TransactionProcessState(FinalizingState _) => new TransactionProcessState(_);
                public static implicit operator TransactionProcessState(CompleteState _) => new TransactionProcessState(_);

                public TransactionProcessState.DownloadState? AsDownloadState => IsT1 ? AsT1 : null;
                public TransactionProcessState.InstallState? AsInstallState => IsT2 ? AsT2 : null;
            ...
            {
                this.State = new TransactionProcessState.FinalizingState();
                return this;
            }
        }
        ...
        public static implicit operator TransactionState(Cancel _) => new TransactionState(_);
